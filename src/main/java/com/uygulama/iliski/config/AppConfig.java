...
@ComponentScan(basePackages = {"com.uygulama.iliski"})
...
public class AppConfig implements AvailableSettings {
    ...
    public LocalSessionFactoryBean getSessionFactory(){
        ...
        factoryBean.setAnnotatedClasses(Customer.class, Address.class);//bu Bean'lerı alıyor --Modeldeki class'ları yazıyoruz
