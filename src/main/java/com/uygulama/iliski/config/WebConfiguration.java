package com.uygulama.iliski.config;
...
@ComponentScan(basePackages={"com.uygulama.iliski.config"}) //Konfigürasyon sınıflarının bulunduğu paket bilgisi
public class WebConfiguration implements WebMvcConfigurer {
    ...
    public InternalResourceViewResolver jspViewResolver() {
        ...
        viewResolver.setPrefix(environment.getProperty("spring.mvc.view.prefix")); //view.properties'in içini doldurmazsak 404 hatası verır
